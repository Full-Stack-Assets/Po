...
class ModelSelector:
    ...
    CAPABILITY_RANKING: Dict[str, List[Tuple[ProviderType, str, float]]] = {
        "research": [
            ...
            (ProviderType.OPENROUTER,  "openai/gpt-4.1",           0.90),
        ...
        "writing": [
            ...
            (ProviderType.OPENROUTER,  "anthropic/claude-sonnet-4-5", 0.89),
        ...
        "code": [
            ...
            (ProviderType.OPENROUTER,  "anthropic/claude-sonnet-4-5", 0.91),
        ...
        "classification": [
            ...
            (ProviderType.OPENROUTER,  "openai/gpt-4.1-mini",      0.87),
        ...
        "summarization": [
            ...
            (ProviderType.OPENROUTER,  "google/gemini-2.5-flash",   0.90),
